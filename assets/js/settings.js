		...
		var e = r(156),
			o = {
				plain: {
					...
					purple: "#824EE1",
					"dodger-blue": "#5567FF",
					"dodger-blue-20": Object(e.hexToRGB)("#5567FF", .2)
				},
				darkMode: {
					border: "#19191A",
					bodyBg: "#1D2126"
			...
			i = {
				...
				charts: {
					...
					defaultFontSize: 13,
					colors: {
						area: Object(e.hexToRGB)(o.primary[500], .24)
					}
				}
			};
